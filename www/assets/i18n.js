const translations = {
    es: {
        ...
        compare_mode: "Comparar vs:",
        compare_days: "Mismos días antes",
        compare_month: "Mes calendario anterior",
        compare_year: "Mismo rango, año anterior",
        view_as_table: "Ver como tabla",
        ...
        month: "Mes",
        new_period: "Nuevo",
        customize: "Personalizar color y estilo",
        customize_hint: "Toca el color de una serie para cambiar su color, estilo y grosor",
        ...
        lbl_vencido: "Vencido",
        lbl_pay: "Pagar",
        msg_tx_saved: "Movimiento guardado exitosamente",
        msg_tx_updated: "Movimiento actualizado exitosamente",
        ...
        copyright: "Copyright GabHoX ghdiez.01@gmail.com - 2026 todos los derechos reservados.",
        btn_close: "Cerrar",
        ...
        axis_month: "Mes",
        pivot_other: "Otro",
        pivot_general: "General",
        pivot_total: "Total",
        pivot_no_data: "No hay datos para el período o filtros seleccionados.",
        pivot_export_csv: "Exportar CSV",
        pivot_sort_value: "Ordenar por valor",
        button: "Actualizar",
        ...
        cfg_preferences: "Preferencias",
        show_totals: "Mostrar totales de ingresos/gastos",
        show_totals_hint: "Muestra u oculta la fila de ingresos y gastos totales en la tarjeta de Saldo Disponible.",
        auto_backup: "Backup automático diario",
        auto_backup_hint: "Genera una copia de seguridad silenciosa al abrir o minimizar la app, una vez al día.",
        last_backup_label: "Último backup: {date}",
        last_backup_never: "Sin backups automáticos aún",
        backup_dest: "Carpeta de destino del backup",
        backup_dest_doc_sub: "Documentos / SmartFinance",
        backup_dest_doc_root: "Documentos (raíz)",
        backup_dest_cache: "Caché interno",
        backup_filename_prefix: "Nombre de archivo (prefijo)",
        backup_filename_example: "Ejemplo: {name}",
        err_invalid_filename: "El nombre no puede contener: \\ / : * ? \" < > |"
    },
    en: {
        app_title: "SmartFinance",
        backup: "Backup",
        ...
        compare_mode: "Compare vs:",
        compare_days: "Same days before",
        compare_month: "Previous calendar month",
        compare_year: "Same range, previous year",
        ...
        month: "Month",
        new_period: "New",
        customize: "Customize color and style",
        customize_hint: "Tap a series' color to change its color, line style and width",
        ...
        copyright: "Copyright GabHoX ghdiez.01@gmail.com - 2026 all rights reserved.",
        btn_close: "Close",
        ...
        pivot_general: "General",
        pivot_total: "Total",
        pivot_no_data: "No data for the selected period or filters.",
        pivot_export_csv: "Export CSV",
        pivot_sort_value: "Sort by value",
        btn_update: "Update",
        ...
        lbl_vencido: "Overdue",
        lbl_pay: "Pay",
        msg_tx_saved: "Transaction saved successfully",
        msg_tx_updated: "Transaction updated successfully",
        ...
        cfg_preferences: "Preferences",
        show_totals: "Show total income/expenses",
        show_totals_hint: "Shows or hides the total income and expenses row on the Available Balance card.",
        auto_backup: "Daily automatic backup",
        auto_backup_hint: "Creates a silent backup when opening or minimizing the app, once a day.",
        last_backup_label: "Last backup: {date}",
        last_backup_never: "No automatic backups yet",
        backup_dest: "Backup destination folder",
        backup_dest_doc_sub: "Documents / SmartFinance",
        backup_dest_doc_root: "Documents (root)",
        backup_dest_cache: "Internal cache",
        backup_filename_prefix: "File name (prefix)",
        backup_filename_example: "Example: {name}",
        err_invalid_filename: "Name cannot contain: \\ / : * ? \" < > |"
    },
    pt: {
        app_title: "SmartFinance",
        backup: "Backup",
        ...
        compare_mode: "Comparar com:",
        compare_days: "Mesmos dias antes",
        compare_month: "Mês calendário anterior",
        compare_year: "Mesmo intervalo, ano anterior",
        view_as_table: "Ver como tabela",
        ...
        month: "Mês",
        new_period: "Novo",
        customize: "Personalizar cor e estilo",
        customize_hint: "Toque na cor de uma série para mudar cor, estilo e espessura",
        ...
        lbl_vencido: "Vencido",
        lbl_pay: "Pagar",
        msg_tx_saved: "Movimento salvo com sucesso",
        msg_tx_updated: "Movimento atualizado com sucesso",
        ...
        copyright: "Copyright GabHoX ghdiez.01@gmail.com - 2026 todos os direitos reservados.",
        btn_close: "Fechar",
        ...
        pivot_general: "Geral",
        pivot_total: "Total",
        pivot_no_data: "Nenhum dado para o período ou filtros selecionados.",
        pivot_export_csv: "Exportar CSV",
        pivot_sort_value: "Ordenar por valor",
        ...
        cfg_preferences: "Preferências",
        show_totals: "Mostrar totais de receitas/despesas",
        show_totals_hint: "Mostra ou oculta a linha de receitas e despesas totais no cartão de Saldo Disponível.",
        auto_backup: "Backup automático diário",
        auto_backup_hint: "Cria um backup silencioso ao abrir ou minimizar o app, uma vez por dia.",
        last_backup_label: "Último backup: {date}",
        last_backup_never: "Ainda sem backups automáticos",
        backup_dest: "Pasta de destino do backup",
        backup_dest_doc_sub: "Documentos / SmartFinance",
        backup_dest_doc_root: "Documentos (raiz)",
        backup_dest_cache: "Cache interno",
        backup_filename_prefix: "Nome do arquivo (prefixo)",
        backup_filename_example: "Exemplo: {name}",
        err_invalid_filename: "O nome não pode conter: \\ / : * ? \" < > |"
    }
};
